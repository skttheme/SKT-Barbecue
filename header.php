...
<?php esc_html_e( 'Skip to content', 'skt-barbecue' ); ?>
</a>
<?php
...
<div class="header <?php if( !is_home() && is_front_page() && $header_trans == '') {echo esc_html('transheader');}elseif(!is_home() && !is_front_page() && $header_trans_inner == '') {echo esc_html('transheader');}?>">
	<div class="container">
    <div class="logo">
		<?php skt_barbecue_the_custom_logo(); ?>
        <div class="clear"></div>
		<?php	
    ...
    <div class="heder-rightside">
                ...
                <div class="skt-header-quote-btn">
                	...
                	<a href="<?php echo esc_url($headerbtnlink); ?>" target="_blank">
                    <?php } ?>
            	...
            	<button class="header-search-toggle"><img src="<?php echo esc_url(get_stylesheet_directory_uri());?>/images/search-icon.png"/></button>
            	<div class="header-search-form">
                    <form method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
                      <input type="search" class="search-field" placeholder="<?php esc_attr_e( 'Search', 'skt-barbecue' ); ?>" name="s">
                      <input type="submit" class="search-submit" value="<?php esc_attr_e( 'Search', 'skt-barbecue' ); ?>">
                    </form>
          		</div>
